...
import { getFirestore, collection, query, where, getDocs, orderBy, addDoc, onSnapshot } from "firebase/firestore";
...
export { db, collection, query, where, getDocs, orderBy, addDoc, onSnapshot };
